export default function projects() {
  return (
    <>
      {" "}
      <div className="bg-gray-800 inline-flex px-6 py-8 font-serif">
        <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700 m-5">
          ...
          <div className="p-5">
            ...
            >
              Code
              <svg
                className="w-6 h-6 text-blue-350 hover:text-blue-800 "
      ...
      <div className="bg-gray-800 inline-flex px-6 py-2 font-serif">
        <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700 m-5">
          <a href="#">
            <img
              className="rounded-t-lg"
